...
const testimonials = [
  ...
  },
  {
    ...
    content: "We've been using Fresh People for all our equipment hire needs. Quality gear and reliable delivery every time.",
    rating: 5,
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {['500+ Events Staffed', '98% Satisfaction', '5-Star Rated Service', '24/7 Support'].map((badge) => (
